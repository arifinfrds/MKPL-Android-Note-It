...
public class AddTaskActivity extends AppCompatActivity implements
    ...
    private void loadSavedIDataInstance(Bundle savedInstanceState) {
        if (savedInstanceState != null) {
            String date = savedInstanceState.getString(EXTRA_DATE, mDueDateView.getText().toString());
            mDueDateView.setText(date);
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        if (mDueDateView != null) {
            outState.putString(EXTRA_DATE, mDueDateView.getText().toString());
        }
    ...
    public void onDateSet(DatePicker view, int year, int month, int day) {
        ...
        if(c.getTimeInMillis() == Long.MAX_VALUE) {
            setDateSelection(Long.MAX_VALUE);
        } else {
    ...
    private void saveItem() {
        ...
        if(TextUtils.isEmpty(mDescriptionView.getText().toString())) {
            mDescriptionView.setError(getString(R.string.task_description) + " is required");
        } else {
