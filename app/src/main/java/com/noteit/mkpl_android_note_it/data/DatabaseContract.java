...
public class DatabaseContract {
    ...
    public static final class TaskColumns implements BaseColumns {
        ...
        static final int POSITION_DESCRIPTION = 1;
        static final int POSITION_IS_COMPLETE = 2;
        static final int POSITION_IS_PRIORITY = 3;
        static final int POSITION_DUE_DATE = 4;
